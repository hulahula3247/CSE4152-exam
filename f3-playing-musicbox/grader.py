...
# =========================
TIME_LIMIT = 2.0   # seconds per testcase

scores =     [20, 10, 10, 10, 10, 10, 10, 10, 10] # 각 서브태스크 점수
test_cases = [17, 16, 34, 19, 18, 58, 21, 20, 64] # 각 서브태스크 내 테케 개수
...
SUBTASKS = [
    ...
    {"name": "Subtask 2", "count": test_cases[1], "requires": []},
    {"name": "Subtask 3", "count": test_cases[2], "requires": [0, 1]},
    {"name": "Subtask 4", "count": test_cases[3], "requires": [0]}, 
    {"name": "Subtask 5", "count": test_cases[4], "requires": [1]},
    {"name": "Subtask 6", "count": test_cases[5], "requires": [2, 3, 4]},
    {"name": "Subtask 7", "count": test_cases[6], "requires": [3]},
    {"name": "Subtask 8", "count": test_cases[7], "requires": [4]},
    {"name": "Subtask 9", "count": test_cases[8], "requires": [5, 6, 7]},
]
