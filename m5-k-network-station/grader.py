...
# =========================
TIME_LIMIT = 6.0   # seconds per testcase

scores =     [50, 10, 10, 10, 10, 10] # 각 서브태스크 점수
test_cases = [29, 20, 36, 29, 20, 36] # 각 서브태스크 내 테케 개수
...
SUBTASKS = [
    ...
    {"name": "Subtask 4", "count": test_cases[3], "requires": [0]},  # 0-base
    {"name": "Subtask 5", "count": test_cases[4], "requires": [0, 1, 3]},  # 0-base
    {"name": "Subtask 6", "count": test_cases[5], "requires": [0, 1, 2, 3, 4]},  # 0-base
]
