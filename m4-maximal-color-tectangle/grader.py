...
# =========================
TIME_LIMIT = 3.5   # seconds per testcase

scores =     [40, 15, 15, 15, 15] # 각 서브태스크 점수
test_cases = [15, 6, 31, 26, 10] # 각 서브태스크 내 테케 개수
...
SUBTASKS = [
    ...
    {"name": "Subtask 3", "count": test_cases[2], "requires": [0]},  # 0-base
    {"name": "Subtask 4", "count": test_cases[3], "requires": [0, 2]},  # 0-base
    {"name": "Subtask 5", "count": test_cases[4], "requires": [0, 1, 2, 3]},  # 0-base
]
